...
class Mywin(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        if self.pcbnew_version >= 8:
            ...
            print("Unsupported version of KICAD PCBNEW")
            exit()
...
class SimplePlugin(pcbnew.ActionPlugin):
    ...
    def Run(self):
        ex = wx.App(False)  # Added False to prevent issues with multiple wxApp instances
